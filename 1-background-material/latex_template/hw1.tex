...
\newcommand{\dueDate}{Wednesday, January 25}
...
DUE: \dueDate{} \\ 
TAs: Abhi, Tara, Sami, Alex, Chu, Hang, Monica, Pranay, Abu, Neural, Markov
}
...
\begin{subparts}
    ...
    % \subpart[1] \sone Let $Z = \frac{1}{15}\sum_{i=1}^{16}(X_i-Y)^2$. What is $\mathbb{E}[Z]$?
